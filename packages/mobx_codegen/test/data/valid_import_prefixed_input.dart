...
abstract class UserBase<T extends io.Process> with Store {
  ...
  @observable
  Stream<T> loadDirectory<T extends io.Directory>(String arg1, {T directory}) async* {
    yield directory;
  }

  @observable
  Stream<T?> loadDirectoryNullable<T extends io.Directory>(String? arg1, {T? directory}) async* {
    yield directory;
  }
}
