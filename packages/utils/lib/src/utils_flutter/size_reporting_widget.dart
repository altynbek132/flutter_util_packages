...
///
/// https://github.com/nixrajput/flutter_carousel_widget/blob/master/lib/src/components/size_reporting_widget.dart
    ...
    return NotificationListener<SizeChangedLayoutNotification>(
      ...
      child: SizeChangedLayoutNotifier(
        ...
        child: Container(
          ...
          child: widget.child, // The child widget being tracked for size changes.
        ),
      ),
    );
  }
