...
class MobXTypeInfoDecorator extends DefaultTypeInfoDecorator {
  bool isObservableList(TypeInfo typeInfo) => typeInfo.typeName!.indexOf('ObservableList<') == 0;

  bool isObservableMap(TypeInfo typeInfo) => typeInfo.typeName!.indexOf('ObservableMap<') == 0;

  bool isObservableSet(TypeInfo typeInfo) => typeInfo.typeName!.indexOf('ObservableSet<') == 0;
  ...
  TypeInfo decorate(TypeInfo typeInfo) {
    ...
    typeInfo.isIterable = typeInfo.isIterable || typeInfo.isList || typeInfo.isSet;
...
class ObservableStringConverter implements ICustomConverter<Observable<String>?> {
  const ObservableStringConverter() : super();

  @override
  Observable<String>? fromJSON(dynamic jsonValue, DeserializationContext context) =>
...
class ObservableDateTimeConverter implements ICustomConverter<Observable<DateTime>?> {
  const ObservableDateTimeConverter() : super();

  @override
  Observable<DateTime>? fromJSON(dynamic jsonValue, DeserializationContext context) =>
      jsonValue is String ? Observable<DateTime>(dateConverter.fromJSON(jsonValue, context) as DateTime) : jsonValue;
...
class ObservableNumConverter implements ICustomConverter<Observable<num>?> {
  ...
  @override
  Observable<num>? fromJSON(dynamic jsonValue, DeserializationContext context) =>
...
class ObservableIntConverter implements ICustomConverter<Observable<int>?> {
  ...
  @override
  Observable<int>? fromJSON(dynamic jsonValue, DeserializationContext context) =>
...
class ObservableDoubleConverter implements ICustomConverter<Observable<double>?> {
  const ObservableDoubleConverter() : super();

  @override
  Observable<double>? fromJSON(dynamic jsonValue, DeserializationContext context) =>
      (jsonValue is String || jsonValue is double)
          ? Observable<double>(numberConverter.fromJSON(jsonValue, context) as double)
          : jsonValue;
...
class ObservableBoolConverter implements ICustomConverter<Observable<bool>?> {
  ...
  @override
  Observable<bool>? fromJSON(dynamic jsonValue, DeserializationContext context) =>
      (jsonValue is String || jsonValue is bool)
          ? Observable<bool>(defaultConverter.fromJSON(jsonValue, context) as bool)
          : jsonValue;
...
final mobXAdapter = JsonMapperAdapter(
    ...
    url: 'https://github.com/k-paxian/dart-json-mapper/tree/master/adapters/mobx',
    typeInfoDecorators: {
    ...
    valueDecorators: {
      ...
      typeOf<ObservableList<DateTime>>(): (value) => ObservableList<DateTime>.of(value.cast<DateTime>()),
      typeOf<ObservableList<String>>(): (value) => ObservableList<String>.of(value.cast<String>()),
      typeOf<ObservableList<num>>(): (value) => ObservableList<num>.of(value.cast<num>()),
      typeOf<ObservableList<int>>(): (value) => ObservableList<int>.of(value.cast<int>()),
      typeOf<ObservableList<double>>(): (value) => ObservableList<double>.of(value.cast<double>()),
      typeOf<ObservableList<bool>>(): (value) => ObservableList<bool>.of(value.cast<bool>()),
      // Value decorators for ObservableSet variations
      typeOf<ObservableSet<DateTime>>(): (value) => ObservableSet<DateTime>.of(value.cast<DateTime>()),
      typeOf<ObservableSet<String>>(): (value) => ObservableSet<String>.of(value.cast<String>()),
      typeOf<ObservableSet<num>>(): (value) => ObservableSet<num>.of(value.cast<num>()),
      typeOf<ObservableSet<int>>(): (value) => ObservableSet<int>.of(value.cast<int>()),
      typeOf<ObservableSet<double>>(): (value) => ObservableSet<double>.of(value.cast<double>()),
      typeOf<ObservableSet<bool>>(): (value) => ObservableSet<bool>.of(value.cast<bool>()),
    });
