...
/// [Axis] of the containing [CustomDraggableScrollableSheet].
///
...
/// passed into a [CustomDraggableScrollableSheet] and the sheet has run initState.
///
/// A [CustomDraggableScrollableController] is a [Listenable]. It notifies its
...
class CustomDraggableScrollableController extends ChangeNotifier {
  ...
  /// Returns Whether any [CustomDraggableScrollableController] objects have attached themselves to the
  ...
  /// Reset the attached sheet to its initial size (see: [CustomDraggableScrollableSheet.initialChildSize]).
  void reset() {
    _assertAttached();
...
///     return Scaffold(
///       appBar: AppBar(
///         title: const Text('CustomDraggableScrollableSheet'),
///       ),
...
class CustomDraggableScrollableSheet extends StatefulWidget {
  ...
  @override
  State<CustomDraggableScrollableSheet> createState() => _DraggableScrollableSheetState();
}
...
/// [CustomDraggableScrollableSheet].
///
/// [CustomDraggableScrollableSheet] widgets notify their ancestors when the size of
...
/// [CustomDraggableScrollableSheet] widgets. To focus on notifications from the
/// nearest [CustomDraggableScrollableSheet] descendant, check that the [depth]
...
class DraggableScrollableNotification extends Notification with ViewportNotificationMixin {
  /// Creates a notification that the extent of a [CustomDraggableScrollableSheet] has
  /// changed.
  ///
...
class _DraggableSheetExtent {
  _DraggableSheetExtent({
    ...
    bool? hasDragged,
        ...
        _currentSize = (currentSize ?? ValueNotifier<double>(initialSize))..addListener(onSizeChanged),
  ...
  _DraggableSheetExtent copyWith({
    ...
    return _DraggableSheetExtent(
      ...
      currentSize: ValueNotifier<double>(hasDragged ? clampDouble(_currentSize.value, minSize, maxSize) : initialSize),
      hasDragged: hasDragged,
    );
  }
}

class _DraggableScrollableSheetState extends State<CustomDraggableScrollableSheet> {
...
/// by a [CustomDraggableScrollableSheet].
///
/// If a [CustomDraggableScrollableSheet] contains content that is exceeds the height
...
class _DraggableScrollableSheetScrollController extends ScrollController {
  ...
  @override
  _DraggableScrollableSheetScrollPosition get position => super.position as _DraggableScrollableSheetScrollPosition;
...
/// A widget that can notify a descendent [CustomDraggableScrollableSheet] that it
...
/// its constructor (see [CustomDraggableScrollableSheet.controller]).
class DraggableScrollableActuator extends StatelessWidget {
  /// Creates a widget that can notify descendent [CustomDraggableScrollableSheet]s
  ...
  /// This child's [CustomDraggableScrollableSheet] descendant will be reset when the
  ...
  /// Notifies any descendant [CustomDraggableScrollableSheet] that it should reset
  /// to its initial position.
  ///
  /// Returns `true` if a [DraggableScrollableActuator] is available and
  /// some [CustomDraggableScrollableSheet] is listening for updates, `false`
  /// otherwise.
...
class _InheritedResetNotifier extends InheritedNotifier<_ResetNotifier> {
  /// Creates an [InheritedNotifier] that the [CustomDraggableScrollableSheet] will
  /// listen to for an indication that it should reset itself back to [CustomDraggableScrollableSheet.initialChildSize].
  ///
  ...
  /// Specifies whether the [CustomDraggableScrollableSheet] should reset to its
  /// initial position.
  ///
