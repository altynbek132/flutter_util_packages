...
mixin _$TodoList on TodoListBase, Store {
  ...
  final _$currentDescriptionAtom = Atom(name: 'TodoListBase.currentDescription');
  ...
  void addTodo(String description) {
    final _$actionInfo = _$TodoListBaseActionController.startAction(name: 'TodoListBase.addTodo');
    try {
  ...
  void removeTodo(Todo todo) {
    final _$actionInfo = _$TodoListBaseActionController.startAction(name: 'TodoListBase.removeTodo');
    try {
  ...
  void changeDescription(String description) {
    final _$actionInfo = _$TodoListBaseActionController.startAction(name: 'TodoListBase.changeDescription');
    try {
  ...
  void changeFilter(VisibilityFilter filter) {
    final _$actionInfo = _$TodoListBaseActionController.startAction(name: 'TodoListBase.changeFilter');
    try {
  ...
  void removeCompleted() {
    final _$actionInfo = _$TodoListBaseActionController.startAction(name: 'TodoListBase.removeCompleted');
    try {
  ...
  void markAllAsCompleted() {
    final _$actionInfo = _$TodoListBaseActionController.startAction(name: 'TodoListBase.markAllAsCompleted');
    try {
