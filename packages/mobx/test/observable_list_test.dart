  ...
  group('ObservableList', () {
    ...
    group('fires reportObserved() for read-methods', () {
      <String, Function(ObservableList<int>)>{
        ...
        'singleWhere': (_) => _ignoreException(() => _.singleWhere((_) => _ == 20, orElse: () => 0)),
      ...
      test('bypass observable system', () {
        ...
        autorun((_) => nonObservableInnerLength = list.nonObservableInner.length);
...
void _templateReadTest(String description, void Function(ObservableList<int>) fn) {
  test(description, () {
    final atom = MockAtom();
...
void _templateWriteTest(String description, bool Function(ObservableList<int>) fn) {
  test(description, () {
    final atom = MockAtom();
    final list = wrapInObservableList(atom, [0, 1, 2, 3]);
...
void _templateIterableReadTest(String description, Iterable Function(ObservableList<int>) testCase) {
  test(description, () {
    final atom = MockAtom();
    final list = wrapInObservableList(atom, [0, 1, 2, 3]);
