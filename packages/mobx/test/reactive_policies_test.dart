...
void main() {
  ...
  group('when reactive-reads are enforced', () {
    setUp(() {
      mainContext.config = ReactiveConfig.main.clone(readPolicy: ReactiveReadPolicy.always);
    });
  ...
  group('when reactive-reads are NOT enforced', () {
    setUp(() {
      mainContext.config = ReactiveConfig.main.clone(readPolicy: ReactiveReadPolicy.never);
    });
