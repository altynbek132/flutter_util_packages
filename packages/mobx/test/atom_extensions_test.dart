...
void main() {
  test('when write to @observable field with changed value, should trigger notifications for downstream', () {
  ...
  // fixed by #855
  test('when write to @observable field with unchanged value, should not trigger notifications for downstream', () {
    final store = _ExampleStore();
  ...
  test('when write to @alwaysNotify field with unchanged value, should trigger notifications for downstream', () {
    final store = _ExampleStore();
...
mixin _$_ExampleStore on __ExampleStore, Store {
  ...
  set value3(String value) {
    _$value3Atom.reportWrite(value, super.value3, () {
      super.value3 = value;
    }, equals: (String? oldValue, String? newValue) => oldValue?.length == newValue?.length);
  }
}
